...
module.exports = {
  clickOnMenuLinksAndCheckElement: function (client, gui = "", mainMenu, subMenu, pageSelector, describe1 = "", describe2 = "", pause = 0, tabMenu = "") {
    ...
    if (gui === "takescreenshot") {
      ...
      test('should take Screenshot of ' + describe1 + ' ' + describe2 + ' page and compare with the previous version', () => {
        return promise
          .then(() => client.waitUntilIsNotVisible(Menu.loader))
          .then(() => client.waitUntilIsNotVisible(Menu.symfony_loader))
          .then(() => client.wholePageScreenshot('GUI_' + global.version + '/' + describe1 + ' ' + describe2 + '.png'))
  ...
  openAllMenuLinkBO: function (gui) {
    ...
    scenario('Check all the menu links of "CONFIGURE"', () => {
      scenario('Check all the menu links of "Shop Parameters" in the Back Office', client => {
        ...
        this.clickOnMenuLinksAndCheckElement(client, gui, Menu.Configure.ShopParameters.shop_parameters_menu, Menu.Configure.ShopParameters.general_submenu, PagesForm.ShopParameters.maintenance_tab_form, "Shop Parameters", "Maintenance", 0, Menu.Configure.ShopParameters.maintenance_tab);
