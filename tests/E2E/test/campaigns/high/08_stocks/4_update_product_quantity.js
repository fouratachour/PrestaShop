...
scenario('Increase & decrease the quantity for one product using the arrow up/down button and save by the "Check" sign', () => {
  ...
  scenario('Increase quantity of products using the arrow up button', client => {
    ...
    test('should check the success panel', () => client.waitForVisible(Stock.success_hidden_panel));
  }, 'stocks');

  scenario('should check the Increase quantity of products movement', client => {
    stock_common_scenarios.checkMovementHistory(client, Menu, Movement, 1, "5", "+", "Employee Edition");
    stock_common_scenarios.checkMovementHistory(client, Menu, Movement, 2, "5", "+", "Employee Edition");
    stock_common_scenarios.checkMovementHistory(client, Menu, Movement, 3, "5", "+", "Employee Edition");
  }, 'stocks');
